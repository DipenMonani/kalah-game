...
public class GameControllerTest {
	...
	public void createNewGame() throws Exception {
		final MockHttpServletRequestBuilder playGameRequest = MockMvcRequestBuilders.post("/api/kalah/games");
	...
	public void play() throws Exception {
		...
		final MockHttpServletRequestBuilder gameRequest = MockMvcRequestBuilders
				.put("/api/kalah/games/" + game.getId() + "/pits/1");
		this.mockMvc.perform(gameRequest).andExpect(MockMvcResultMatchers.status().isOk())
